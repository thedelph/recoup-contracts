...
reach test, as they said it would, and adds four suites and 39 tests:
[`test/Issue64_MarkRoute.t.sol`](test/Issue64_MarkRoute.t.sol),
[`test/Issue64_DustCensusReplay.t.sol`](test/Issue64_DustCensusReplay.t.sol),
[`test/Issue64_DustUnderShortfall.t.sol`](test/Issue64_DustUnderShortfall.t.sol) and
[`test/Issue64_HonestCompletion.t.sol`](test/Issue64_HonestCompletion.t.sol), the last added on
2026-09-24 when the fix's write-down began rounding the worth up, which moved six of the flipped
